...
typedef struct __tNFCControllerInfo
{
   ...
   uint32_t nSENumber;
   tNFCControllerSEInfo aSEInfoArray[NAL_MAXIMUM_SE_NUMBER];
...
/**
 * Writes the content of the persistent memory in a buffer.
 *
 * @param[in]  pBuffer  The buffer where to write the persistent memory.
 *
 * @param[out] pPolicyParameter  The policy parameter used to write
...
/**
 * Returns the UICC access rights.
 *
 * @param[in]  pContext  The current context.
 *
 * @param[in]  nStorageType  The stroage type.
 *
 * @param[out] pnReaderISO14443_A_Priority  A variable valued with the reader A priority.
 *
 * @param[out] pnReaderISO14443_B_Priority  A variable valued with the reader B priority.
 *
 * @param[out] pnCardAccessProtocol  A variable valued with the bit field
 *             representing the UICC card access rights.
 *
...
/**
 * Sets the UICC access rights.
 *
 * @param[in]  pContext  The current context.
 *
 * @param[in]  nStorageType  The stroage type.
 *
 * @param[in]  nReaderISO14443_A_Priority  The reader A priority.
 *
 * @param[in]  nReaderISO14443_B_Priority  The reader B priority.
 *
 * @param[in]  nCardAccessProtocols  The bit-field representing the UICC card access rights.
 *
