                              ...
                              uint16_t nParamCode)
{
   ...
   switch(nParamCode)
   {
      ...
      case NAL_PAR_P2P_INITIATOR_LINK_PARAMETERS:
         ...
         break;
      case NAL_PAR_P2P_TARGET_PARAMETERS:
         PUtilTraceASCIIStringCopy(pTraceBuffer, &nPos, "P2P_TARGET_PARAMETERS " );
         break;
      case NAL_PAR_P2P_TARGET_RTX:
         PUtilTraceASCIIStringCopy(pTraceBuffer, &nPos, "P2P_TARGET_RTX " );
         break;
      ...
      case NAL_PAR_UICC_CARD_PROTOCOLS:
         ...
         break;
      case NAL_PAR_SE_PRESENT:
         PUtilTraceASCIIStringCopy(pTraceBuffer, &nPos, "SE_PRESENT " );
         break;
 ...
 *
 * @param[in]  bFromNFCC  The direction flag. true for NFCC to NFC Device, false for
 *             NFC Device to NFCC.
 *
         ...
         uint32_t nPosition)
{
   ...
   uint8_t nNALServiceIdentifier = *pBuffer;
   char* pTemp;
   uint8_t nType;
   uint8_t nValue;
   sint32_t nSize = (sint32_t)nLength;
   bool bOptionTrace = true;
   ...
   switch(nValue)
   {
      ...
      **/
      ...
      case NAL_EVT_RF_FIELD:
         ...
         break;
      case NAL_EVT_SE_HOT_PLUG:
         PUtilTraceASCIIStringCopy(pTraceBuffer, &nPos, "SE_HOT_PLUG " );
         break;
