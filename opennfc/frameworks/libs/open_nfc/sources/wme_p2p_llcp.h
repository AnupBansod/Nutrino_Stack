...
#define LLCP_MAX_LOCAL_MIUX                   128
#define LLCP_MAX_REMOTE_MIUX                  128
...
struct __tDecodedPDU
{
   ...
   union
   {
      ...
      struct
      {
         struct
         {
            bool bIsPresent;              /**< Indicates if the VERSION parameter is present */
         ...
         struct
         {
            bool        bIsPresent;       /**< Indicates if the MIUX parameter is present */
         ...
         struct
         {
            bool        bIsPresent;       /**< Indicates if the WKS parameter is present */
         ...
         struct
         {
            bool        bIsPresent;       /**< Indicates if the LTO parameter is present */
         ...
         struct
         {
            bool        bIsPresent;       /**< Indicates if the RW parameter is present */
            uint8_t     nRW;              /**< Receive Window size */
         } sRW;

         struct
         {
            bool        bIsPresent;       /**< Indicates if the SN parameter is present */
         ...
         struct
         {
            bool        bIsPresent;       /**< Indicates if the OPT parameter is present */
            uint8_t     nLSC;             /**< Link Service Class */
         } sOPT;

         struct
         {
            bool        bIsPresent;       /**< Indicates if the SDREQ parameter is present */
         ...
         struct
         {
            bool        bIsPresent;       /**< Indicates if the SDRES parameter is present */
            uint8_t     nTID;             /**< The transaction Id */
...
typedef void  tLinkDeactivationCallback (void *);

struct __tLLCPInstance
{
   /* LLCP configuration */

   bool          bActivateInitiator;   /**< request activation of the P2P initiator */
