...
#include "wme_j_edition.h"
#include "wme_crypto_des.h"
#include "wme_zlib.h"


#define P_ERROR_STILL_PENDING                ((W_ERROR)0xFFFFFFFF)
...
struct __tUserInstance
{
   ...
   const tUserAuthenticationData* pUserAuthenticationData;

   bool bAuthenticationDone;
};
...
struct __tUserInstance
{
   ...
   bool bIsEventPumpWaitingForSemaphore;

   bool bEventPumpShouldDestroyUserInstance;
};
...
/**
 * Returns the UICC user instance.
 *
 * @param[in]  pContext  The context.
 *
 * @return  The UICC instance.
 **/
...
/**
 * Returns the J-Edition helper instance.
 *
 * @param[in]  pContext  The context.
 *
 * @return  The J-Edition helper instance.
 **/
