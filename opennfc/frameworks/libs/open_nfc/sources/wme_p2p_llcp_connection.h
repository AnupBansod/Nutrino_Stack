...
struct __tLLCPConnection
{
   ...
   bool              bShutdownRequested;     /**< connection release has been requested */
   bool              bIsPeerBusy;   /**< Remote peer busy or not */
   bool              bIsBusy;       /**< If true, we are in local congestion, (RNR has been sent) */

   bool              bAtLeastOneIPDUSent;       /**< Set to true if at least one I PDU has been sent, used for NS/NR validation */
   bool              bAtLeastOneIPDUReceived;   /**< Set to true if at least one I PDU has been received, used for NS/NR validation */
