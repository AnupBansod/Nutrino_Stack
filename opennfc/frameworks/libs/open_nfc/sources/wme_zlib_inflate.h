...
#ifndef __WME_ZLIB_INFLATE_H
#define __WME_ZLIB_INFLATE_H
...
struct inflate_state {
    ...
    sint32_t last;                   /* true if processing last block */
    sint32_t wrap;                   /* bit 0 true for zlib, bit 1 true for gzip */
    sint32_t havedict;               /* true if dictionary provided */
    sint32_t flags;                  /* gzip header method and flags (0 if zlib) */
