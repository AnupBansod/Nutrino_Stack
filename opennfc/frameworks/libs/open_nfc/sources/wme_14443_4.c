...
static bool static_P14P4GetProperties(
            tContext* pContext,
            void* pObject,
            uint8_t* pPropertyArray );

/* Check properties connection callback */
static bool static_P14P4CheckProperties(
            tContext* pContext,
            void* pObject,
            ...
            W_ERROR nError)
{
   ...
   bool     bIsCIDFromCardSupported;
   bool     bIsNADFromCardSupported;
   uint8_t  nPCB = 0x00;
   uint8_t  nPrologueLength = 1;
   uint8_t  nWTXM = 1;
   uint8_t  nChainingFlag = 0x00;
   uint8_t  bSendNextBlockNumber = false;
   ...
   bool bIsCIDSupported = false;
   bool bIsNADSupported  = false;
   uint8_t nCID = 0;
   uint8_t nNAD = 0;
   uint32_t nTimeout = 0;
   ...
   if ( nDataLength != 0x00 )
   {
      ...
      if ( bIsCIDSupported != false )
      {
         ...
         if ( bIsCIDFromCardSupported != false )
         {
   ...
   if ( nError == W_SUCCESS )
   {
      ...
      switch (p14P4Connection->nProtocol)
      {
         ...
         case W_PROP_ISO_14443_4_B:
            ...
            if ( p14Part3ConnectionInfo.sW14TypeB.bIsNADSupported != false )
            {
   ...
   switch ( nCommandType )
   {
      ...
      case P_14443_COMMAND_SEND_PPS:
         ...
         P14P3UserExchangeData(
            ...
            PUtilConvertHandleToPointer(hConnection),
            p14P4Connection->aReaderToCardBufferTCL,
            sizeof(pSendPPS) + ((p14P4Connection->s14typeA4.bIsPPSSupported != false) ? 1 : 0),
            p14P4Connection->aCardToReaderBufferTCL,
            P_14443_3_FRAME_MAX_SIZE,
            null,
            true);
