            ...
            W_ERROR nError )
{
   ...
   /* Post the result */
   PDFCPostContext2( &pPicoFormat->sCallbackContext, P_DFC_TYPE_FORMAT5, nError );
                          ...
                          uint8_t nTagType)
{
   ...
   if ( pPicoFormat == null )
   {
      ...
      PDFCPostContext2( &sCallbackContext, P_DFC_TYPE_FORMAT5, W_ERROR_OUT_OF_RESOURCE );
      return;
   }
   ...
   switch (nTagType)
   {
      case W_PROP_PICOPASS_2K :
         PPicoWrite(pContext, hConnection, static_WPicoWriteCompleted, pPicoFormat, g_Pico2KFormat, 0x18, sizeof(g_Pico2KFormat), false, null);
         break;

      case W_PROP_PICOPASS_32K :
         PPicoWrite(pContext, hConnection, static_WPicoWriteCompleted, pPicoFormat, g_Pico32KFormat, 0x18, sizeof(g_Pico32KFormat), false, null);
         break;
   }
}
