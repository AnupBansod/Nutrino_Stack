            ...
            W_ERROR nError )
{
   ...
   PDFCPostContext2( &pType1Format->sCallbackContext, P_DFC_TYPE_FORMAT1, nError);
                          ...
                          uint8_t nTagType)
{
   ...
   if ( pType1Format == null )
   {
      ...
      PDFCPostContext2( &sCallbackContext, P_DFC_TYPE_FORMAT1, W_ERROR_OUT_OF_RESOURCE );
      return;
   }
   ...
   {
      case 0x11 :     /* Topaz */
         PType1ChipWrite(pContext, hConnection, static_PNDEFFormatNDEFType1WriteCompleted, pType1Format, g_Type1StaticFormat, 8, sizeof(g_Type1StaticFormat), false, null );
         return;

      case 0x12 :     /* Topaz 512 */
         PType1ChipWrite(pContext, hConnection, static_PNDEFFormatNDEFType1WriteCompleted, pType1Format, g_Type1Dynamic512Format, 8, sizeof(g_Type1Dynamic512Format), false, null );
         return;
   }

error:

   PDFCPostContext2( &sCallbackContext, P_DFC_TYPE_FORMAT1, nError );
   CMemoryFree(pType1Format);
