 ...
 * @since Open NFC 4.0
 */
public interface NfcTagDetectionEventHandler {

    /**
     * Method called when a new tag is detected.
     *
     * @param connection the connection with the tag.
     */
    void onTagDetected(NfcTagConnection connection);

    /**
     * Method called when an error occurs during a detection.
     *
     * @param what the type of the error.
     */
    void onTagDetectedError(NfcErrorCode what);
}
