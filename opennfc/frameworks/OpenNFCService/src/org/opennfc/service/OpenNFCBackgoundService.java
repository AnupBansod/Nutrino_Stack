...
public class OpenNFCBackgoundService extends Service implements NfcTagDetectionEventHandler {
    ...
    private final IOpenNFCBackgroundService.Stub iOpenNFCBackgroundService = new IOpenNFCBackgroundService.Stub() {
        ...
        public void passOnManualManagement(final IBinder binder) {
            ...
            final IOpenNFCBackgroundService tmp = IOpenNFCBackgroundService.Stub
                    .asInterface(binder);

            if (tmp == null) {
                Log.e(OpenNFCBackgoundService.TAG,
                        "The binder MUST be the binder gives by onServiceConnected when binding with 'org.opennfc.service.OpenNFCBackgoundService.ACTION'");
    ...
    private final CardDetectionEventHandler mCardDetectionEventHandler = new CardDetectionEventHandler() {
        ...
        public void onCardDetected(final Connection connection) {
            ...
            ThreadedTaskManager.MANAGER.doInSeparateThread(
                    OpenNFCBackgoundService.this.threadedSpecialTreatment, connection);
        }
    ...
    INfcTag.Stub mINfcTag = new INfcTag.Stub() {
        ...
        public int formatNdef(final int nativeHandle, final byte[] key) throws RemoteException {
            ...
            try {
                ...
                // If tag is read only, can't format it
                ...
                final org.opennfc.nfctag.NdefRecord ndefRecord = new org.opennfc.nfctag.NdefRecord(
                        NdefTypeNameFormat.EMPTY, (String) null, (byte[]) null);
                ...
                // Format the tag
                nfcInformation.intializeTime();
                connection.writeMessage(ndefMessage, NfcTagManager.ACTION_BIT_CHECK_WRITE
                        | NfcTagManager.ACTION_BIT_ERASE
                        | NfcTagManager.ACTION_BIT_FORMAT_BLANK_TAG);
                ...
                this.lastErrorCode = HelperForNfc.obtainErrorCode(this.lastException,
                        ErrorCodes.ERROR_WRITE);
        ...
        public byte[] getUid(final int nativeHandle) throws RemoteException {
            ...
            try {
                // Obtain the result
                final byte[] result = nfcInformation.overideID != null
                        ? nfcInformation.overideID
        ...
        public int ndefMakeReadOnly(final int nativeHandle) throws RemoteException {
            ...
            try {
                ...
                nfcInformation.intializeTime();
                connection.writeMessage(connection.readMessage(),
                        NfcTagManager.ACTION_BIT_CHECK_WRITE | NfcTagManager.ACTION_BIT_ERASE
                                | NfcTagManager.ACTION_BIT_LOCK);
            } catch (final NfcException exception) {
                this.lastException = exception;
                this.lastErrorCode = HelperForNfc.obtainErrorCode(this.lastException,
                        ErrorCodes.ERROR_WRITE);
        ...
        public android.nfc.NdefMessage ndefRead(final int nativeHandle) throws RemoteException {
            ...
            try {
                final android.nfc.NdefMessage message = new android.nfc.NdefMessage(connection
                ...
                this.lastErrorCode = HelperForNfc.obtainErrorCode(this.lastException,
                        ErrorCodes.ERROR_INVALID_PARAM);
            }
         ...
         */
        @Override
        public int ndefWrite(final int nativeHandle, final android.nfc.NdefMessage msg)
            ...
            try {
                if (OpenNFCBackgoundService.DEBUG) {
                    Log.d(OpenNFCBackgoundService.TAG,
                            "WILL write ! WILL write ! WILL write ! WILL write ! WILL write ! WILL write ! ");
                }

                connection.writeMessage(new NdefMessage(msg.toByteArray()),
                        NfcTagManager.ACTION_BIT_CHECK_WRITE | NfcTagManager.ACTION_BIT_ERASE);
            } catch (final NfcException exception) {
                this.lastException = exception;
                this.lastErrorCode = HelperForNfc.obtainErrorCode(this.lastException,
         ...
         */
        @Override
        public TransceiveResult transceive(final int nativeHandle, final byte[] data,
                final boolean raw) throws RemoteException {
            this.lastException = null;
            this.lastErrorCode = ErrorCodes.SUCCESS;
    ...
    private final ThreadedTask<NfcTagConnection> onTagDetectedTask = new ThreadedTask<NfcTagConnection>() {
        ...
        public void excuteTask(final int taskID, final NfcTagConnection... parameters) {
            ...
            try {
                ...
                // NFC
                // messages
                final byte[] content = message == null
                        ? null
                        : message.getContent();

                if (content != null) {
                    msgs = new android.nfc.NdefMessage[] {
                        new android.nfc.NdefMessage(content)
                    };
                }
                ...
                // the
                // tag
                final ConvertInformationNfc convertInformationNfc = ConvertInformationNfc.create(
                        connection,//
                        msgs == null
                                ? null
                                : msgs[0], //
                ...
                final Tag tag = new Tag(connection.getIdentifier(),
                        convertInformationNfc.technologies, convertInformationNfc.bundles,
                        convertInformationNfc.handle, OpenNFCBackgoundService.this.mINfcTag);
    ...
    private final ThreadedTask<byte[]> threadedSendMessage = new ThreadedTask<byte[]>() {
        ...
        public void excuteTask(final int taskID, final byte[]... parameters) {
            OpenNFCBackgoundService.this.sendTag(Tag.createMockTag(null, new int[] {
                TagTechnology.NDEF
            }, new Bundle[] {
                new Bundle()
            }), new android.nfc.NdefMessage[] {
                new android.nfc.NdefMessage(new NdefRecord[] {
                    new NdefRecord(NdefRecord.TNF_UNKNOWN, new byte[0], new byte[0], parameters[0])
                })
            });
        }
    };
    ...
    final ThreadedTask<Connection> threadedSpecialTreatment = new ThreadedTask<Connection>() {
        ...
        public void excuteTask(final int taskID, final Connection... parameters) {
            ...
            final ConvertInformationNfc convertInformationNfc = ConvertInformationNfc
                    .createConnection(connection);

            if (convertInformationNfc != null) {
                try {
                    final Tag tag = Tag.createMockTag(convertInformationNfc.overrideID,
                            convertInformationNfc.technologies, convertInformationNfc.bundles);
     ...
     */
    private Intent buildTagIntent(final Tag tag, final android.nfc.NdefMessage[] msgs,
            final String action) {
    ...
    public void onCreate() {
        ...
        this.mWakeLock = ((PowerManager) this.getSystemService(Context.POWER_SERVICE)).newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, OpenNFCBackgoundService.TAG);
        ...
        /*
         * First we must get a single instance of the NFC manager.
         */
        if (OpenNFCBackgoundService.DEBUG) {
        ...
        if (OpenNFCBackgoundService.DEBUG) {
            Log.d(OpenNFCBackgoundService.TAG, "$$$$$$$$$$$$$$$$$$$$$$$>>>>>>>>>>>>>> mNfcManager="
                    + this.mNfcManager);
        }

        /*
         * Get the single instance of NFC Tag Manager.
         */
        if (OpenNFCBackgoundService.DEBUG) {
        ...
        try {
            /*
             * Starts the NFC Manager. This method shall be called once before
             * any usage of the other NFC objects. Use stop() when the NFC
        ...
        /*
         * Registers a read event handler to detect a URI message on every tag
         * detected only when the activity start interacting with the user.
         */
        try {
            // this.mNfcTagManager.registerTagListener(NfcPriority.MAXIMUM,
            // this);
            this.mNfcManager.getCardListenerRegistry().registerCardListener(NfcPriority.MAXIMUM,
                    this.mCardDetectionEventHandler);
            this.isRegistered = true;
            this.mNfcManager.getNfcController().registerCardCollisionHandler(
                    this.mControllerListener);
            this.mNfcManager.getNfcController().registerExceptionEventHandler(
                    this.mControllerListener);
        } catch (final Exception exception) {
            if (OpenNFCBackgoundService.DEBUG) {
        ...
        ClientServer clientServer = ClientServerCache.CACHE
                .get(OpenNFCBackgoundService.this.server_com_android_npp);
        if (clientServer == null) {
            OpenNFCBackgoundService.this.server_com_android_npp = ClientServerCache.CACHE
                    .createClientServer(OpenNFCService.SERVER_COM_ANDROID_NPP_NAME,
    ...
    public void onDestroy() {
        ...
        // Stop the NFC Manager in separate thread to avoid ANR
        ThreadedTaskManager.MANAGER.doInSeparateThread(this.mStopNfcManager);
        this.mNfcManager.getCardListenerRegistry().unregisterCardListener(
                this.mCardDetectionEventHandler);
        this.mNfcManager.getNfcController()
                .unregisterCardCollisionHandler(this.mControllerListener);
        this.mNfcManager.getNfcController().unregisterExceptionEventHandler(
                this.mControllerListener);
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId) {
        Log.i(OpenNFCBackgoundService.TAG, "onStartCommand:" + "Received start id " + startId
                + ": " + intent);
     ...
     */
    private boolean sendIntent(final Intent intent, final IntentFilter[] overrideFilters,
            final PendingIntent overrideIntent, final String[][] overrideTechLists) {
        if (overrideIntent != null) {
            ...
            if (overrideFilters == null && overrideTechLists == null) {
                ...
                for (final IntentFilter filter : overrideFilters) {
                    if (filter.match(OpenNFCBackgoundService.this.getContentResolver(), intent,
                            false, OpenNFCBackgoundService.TAG) >= 0) {
                        found = true;
                        break;
                    }
                }
            ...
            if (found == true) {
                Log.i(OpenNFCBackgoundService.TAG, "Dispatching to override intent "
                        + overrideIntent);
                try {
            ...
            // If the current app called stopAppSwitches() then our
            // startActivity()
            // can be delayed for several seconds. This happens with the default
            // home
    ...
    public void sendMessage(final byte[] temp, final int length) {
        ThreadedTaskManager.MANAGER.doInSeparateThread(this.threadedSendMessage,
                Arrays.copyOf(temp, length));
    }
     ...
     */
    private boolean sendNdefDiscovered(final Tag tag, final android.nfc.NdefMessage[] msgs,
            final IntentFilter[] overrideFilters, final PendingIntent overrideIntent,
            final String[][] overrideTechLists) {
        if (msgs != null && msgs.length > 0) {
            ...
            if (records.length > 0) {
                ...
                final Intent intent = this.buildTagIntent(tag, msgs,
    ...
    private boolean sendTag(final Tag tag, final android.nfc.NdefMessage[] msgs) {
        ...
        // boolean foregroundNdefPush = mNdefPushClient.getForegroundMessage()
        // != null;
        ...
        return this
                .sendTagDiscovered(tag, msgs, overrideFilters, overrideIntent, overrideTechLists);
    }
     ...
     */
    private boolean sendTagDiscovered(final Tag tag, final android.nfc.NdefMessage[] msgs,
            final IntentFilter[] overrideFilters, final PendingIntent overrideIntent,
            final String[][] overrideTechLists) {
        final Intent intent = this.buildTagIntent(tag, msgs, NfcAdapter.ACTION_TAG_DISCOVERED);
        final boolean result = this.sendIntent(intent, overrideFilters, overrideIntent,
                overrideTechLists);
     ...
     * @return {@code true} if intent sent
     */
    private boolean sendTechDiscovered(final Tag tag, final android.nfc.NdefMessage[] msgs,
            final IntentFilter[] overrideFilters, final PendingIntent overrideIntent,
            final String[][] overrideTechLists) {
        final String[] tagTechs = tag.getTechList();

        final ArrayList<ResolveInfo> matches = RegisteredPackageList.registeredPacakgeList
                .listOfActivities(NfcAdapter.ACTION_TECH_DISCOVERED,
                        NfcAdapter.ACTION_TECH_DISCOVERED, tagTechs);

        final int size = matches == null
                ? 0
                : matches.size();
        ...
        if (size == 1) {
            ...
            intent.putExtra(Intent.EXTRA_INTENT,
                    this.buildTagIntent(tag, msgs, NfcAdapter.ACTION_TECH_DISCOVERED));
            ...
            try {
                ...
                if (OpenNFCBackgoundService.DEBUG == true) {
                    Log.w(OpenNFCBackgoundService.TAG, "No activities for technology handling of "
                            + intent);
                }
            }
        }
            ...
            switch (tnf) {
                ...
                case android.nfc.NdefRecord.TNF_WELL_KNOWN: {
                    ...
                    if (Arrays.equals(type, android.nfc.NdefRecord.RTD_TEXT)) {
                        ...
                        try {
                            final android.nfc.NdefMessage msg = new android.nfc.NdefMessage(
                                    record.getPayload());
                            for (final android.nfc.NdefRecord subRecord : msg.getRecords()) {
                                final short subTnf = subRecord.getTnf();
                                if (subTnf == android.nfc.NdefRecord.TNF_WELL_KNOWN
