...
/* Open NFC interface */
#define P_NFC_HAL_BINDING_INTERFACE                            0x30  /* New interface in microread firmware 7.0 */
...
#define P_NFC_HAL_BINDING_MAX_OPERATIONS                64
...
struct __tNALBindingContext
{
  ...
  /* Write callback and params*/
   ...
   uint16_t                     nHCIActivatedCardProtocol;
   uint8_t                      nHCICardActivatedServiceIdentifier;
   uint8_t                      nNALCardActivatedServiceIdentifier;
   uint16_t                     nNALReaderProtocol;
   uint8_t                      nDetectionState;
   uint32_t                     nLSSReceptionCounter;
  ...
  /* Service Operation */
   ...
   bool                         bIsLowPowerRequested;                      /**< low power mode has been requested by user ? */
   ...
   bool                         bSendDetectionAnswerOnNextSimRequest;
