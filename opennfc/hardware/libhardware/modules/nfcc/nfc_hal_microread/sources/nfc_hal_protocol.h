 ...
 *
 * @param[out] pbIsReaderLocked  The reader lock. true if locked.
 *
 * @param[out] pbIsCardLocked  The card lock. true if locked.
 *
 ...
 * @param[in] pBuffer  The parameter buffer.
 *
 * @param[in] bIsReaderLocked  The reader lock. true if locked.
 *
 * @param[in] bIsCardLocked  The card lock. true if locked.
 *
...
/**
 * Parses the parameter NAL_PAR_P2P_TARGET_PARAMETERS.
 *
 * @param[in] pBuffer  The parameter buffer.
 *
 * @param[in] nLength  The buffer length.
...
/**
 * Parses the parameter NAL_PAR_P2P_TARGET_RTX.
 *
 * @param[in] pBuffer  The parameter buffer.
 *
 * @param[in] nLength  The buffer length.
...
/**
 * Formats the parameter NAL_PAR_SE_PRESENT.
 *
 * @param[out] pBuffer  The parameter buffer.
 *
 * @param[in] nParameter
...
/**
 * Formats the parameter NAL_EVT_SE_HOT_PLUG.
 *
 * @param[out] pBuffer  The parameter buffer.
 *
 * @param[in] bIsSeInserted  0 if the SE is removed, 1 if the SE is inserted.
 **/
